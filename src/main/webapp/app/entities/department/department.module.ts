...
import { HumanressourceSharedModule } from 'app/shared';
import {
  DepartmentComponent,
...
@NgModule({
  imports: [HumanressourceSharedModule, RouterModule.forChild(ENTITY_STATES)],
  declarations: [
    DepartmentComponent,
    DepartmentDetailComponent,
    DepartmentUpdateComponent,
...
export class HumanressourceDepartmentModule {}
